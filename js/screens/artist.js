...
import templateGenre from './genre.js';
...
const templateArtist = createElement(template);
const mainAnswerList = [...templateArtist.querySelectorAll(`.main-answer`)];
mainAnswerList.forEach((item) => {
  item.addEventListener(`click`, () => switchScreen(templateGenre));
});
